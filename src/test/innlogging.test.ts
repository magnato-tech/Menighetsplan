...
assert.deepEqual(
  ...
  ["eksternIcalUrl", "systemmeldingForfallAktivert", "systemmeldingForfallMal", "visKalenderGruppeleder", "visKalenderIcal", "visKalenderMinSide", "visMeldingerMinSide", "visVarselEpost", "visVarselSms"]
);
assert.equal(
  innstillingRader
