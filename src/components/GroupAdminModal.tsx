    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-white rounded-2xl max-w-4xl w-full p-6 shadow-2xl border border-slate-200 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between gap-2 mt-6 pt-4 border-t border-slate-100">
          <button
            type="button"
            onClick={() => setVisBekreftSlett(true)}
            className="px-4 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-50 rounded-xl transition cursor-pointer"
          >
            Slett gruppe
          </button>
      ...
      {visBekreftSlett && (
        <div
          ...
          onClick={() => setVisBekreftSlett(false)}
        >
          <div
          ...
          >
            ...
            <p className="text-sm text-slate-600 mt-2">
              ...
              <strong>{gruppenavn.trim() || gruppe.Gruppenavn}</strong>? Denne handlingen kan
              ikke angres.
            </p>
